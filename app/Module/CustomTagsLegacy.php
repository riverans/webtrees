...
class CustomTagsLegacy extends AbstractModule implements ModuleConfigInterface, ModuleCustomTagsInterface
{
    ...
    public function customTags(): array
    {
        return [
            ...
            'INDI:_TODO'             => new CustomElement('Indicates the start of a To-Do record that describes the item to be done.'),
            ...
            // How is this used?
            '_PREF'          => new CustomElement('Indicates a Preferred spouse, child or parents.'),
