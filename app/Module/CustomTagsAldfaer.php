...
class CustomTagsAldfaer extends AbstractModule implements ModuleConfigInterface, ModuleCustomTagsInterface
{
    ...
    {
        return [
            'MARR_CIVIL'     => new CustomElement(I18N::translate('Civil marriage')),
            'MARR_RELIGIOUS' => new CustomElement(I18N::translate('Religious marriage')),
            'MARR_PARTNERS'  => new CustomElement(I18N::translate('Registered partnership')),
            'MARR_UNKNOWN'   => new CustomElement(I18N::translate('Marriage type unknown')),
        ];
    }
